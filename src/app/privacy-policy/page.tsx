  ...
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="May 30, 2026">
      <section className="space-y-6">
        ...
        <p>Like any other website, VSNEXOS uses &ldquo;cookies&rdquo;. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.</p>
