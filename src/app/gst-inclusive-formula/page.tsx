        ...
        <div className="space-y-12">
          <section className="space-y-6">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              When a price is &ldquo;GST Inclusive,&rdquo; it means the Goods and Services Tax has already been added to the base cost of the product or service. This is the final amount a consumer pays at a retail store. If you are a business owner, you often need to find the base price and the tax component from this total to file your returns.
            </p>
          </section>
