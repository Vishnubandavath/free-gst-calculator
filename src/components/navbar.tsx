      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-20 left-0 right-0 w-full bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 shadow-xl lg:hidden max-h-[calc(100vh-5rem)] overflow-y-auto"
          >
